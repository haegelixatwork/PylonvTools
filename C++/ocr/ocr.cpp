...
int main(int /*argc*/, char* /*argv*/[])
{
    ...
    try
    {
        ...
        string pylonDir(buf);
        string imageDir = pylonDir + "\\Samples\\pylonDataProcessing\\C++\\images\\ocr\\";
        ...
        recipe.GetParameters().Get(StringParameterName("ImageLoading/@vTool/SourcePath")).SetValue(imageDir.c_str());
